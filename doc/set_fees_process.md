...
Indy CLI will print the transaction after these steps. Expected output:
...
Indy CLI will print the transaction with your signature after these steps. Expected output:
...
Received ledger reply json will be printed in cli. Expected output:
